module.exports = {
	'apps/frontend-dashboard/**/*.{ts,tsx,cjs}': 'pnpm --filter frontend exec eslint -c ./.eslintrc.cjs --ignore-path ./.eslintignore --fix',
	...
	'apps/slack-webhook-register-function/**/*.{ts,js,cjs}':
