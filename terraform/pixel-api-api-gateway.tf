module "pixel_api_api_gateway" {
  ...
  integrations = {
    "GET /github-webhook-listener" = {
      lambda_arn             = aws_lambda_function.github_webhook_listener_lambda.arn
...
resource "aws_lambda_permission" "api_gw_permission_invoke_github_webhook_listener_lambda" {
  statement_id  = "AllowAPIGatewayInvoke"
  action        = "lambda:InvokeFunction"
  function_name = aws_lambda_function.github_webhook_listener_lambda.function_name
