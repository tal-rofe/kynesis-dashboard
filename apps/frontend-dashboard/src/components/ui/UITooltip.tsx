...
const UITooltipProvider = TooltipPrimitive.Provider;

const UITooltip = TooltipPrimitive.Root;

const UITooltipTrigger = TooltipPrimitive.Trigger;

const UITooltipContent = React.forwardRef<React.ElementRef<typeof TooltipPrimitive.Content>, React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>>(
