...
const UIDropdownMenu = DropdownMenuPrimitive.Root;
...
UIDropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName;
...
UIDropdownMenuSubContent.displayName = DropdownMenuPrimitive.SubContent.displayName;
...
UIDropdownMenuCheckboxItem.displayName = DropdownMenuPrimitive.CheckboxItem.displayName;
...
UIDropdownMenuRadioItem.displayName = DropdownMenuPrimitive.RadioItem.displayName;
...
UIDropdownMenuSeparator.displayName = DropdownMenuPrimitive.Separator.displayName;

const UIDropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
